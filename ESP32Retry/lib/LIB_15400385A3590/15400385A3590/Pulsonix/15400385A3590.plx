...
(library Library_1
	...
	(patternDef "15400385A3590" (originalName "15400385A3590")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.18 0) (pt -0.18 0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, 0) (radius 1.45) (startAngle 180) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.72 0) (pt 2.72 0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, 0) (radius 1.45) (startAngle .0) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "15400385A3590" (originalName "15400385A3590") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		...
		(attr "<Hyperlink>" "https://www.we-online.com/katalog/datasheet/15400385A3590.pdf")
		(attr "<Component Height>" "10.9")
		(attr "<STEP Filename>" "15400385A3590.stp")
